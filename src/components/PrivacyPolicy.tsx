                ...
                <div className="row">
                    <div className="col p-5 bg-dark text-white text-justify">
                        <div className="d-flex flex-column mx-auto w-75">
                            <h1>Privacy Policy for LCShop</h1>

                            <p>At LCShop, one of our main priorities is the privacy of
                                our visitors. This Privacy Policy document contains types of information that is
                                collected and recorded by LCShop and how we use it.</p>
                            ...
                            <p>LCShop follows a standard procedure of using log files. These files log visitors when
                            ...
                            <p>You may consult this list to find the Privacy Policy for each of the advertising partners
                                of LCShop. Our Privacy Policy was created with the help of the <a
                                    href="https://www.privacypolicygenerator.info" target="_blank" rel="noopener noreferrer">Privacy Policy Generator</a> and the
                                <a href="https://www.generateprivacypolicy.com" target="_blank" rel="noopener noreferrer">Generate Privacy Policy Generator</a>.
                            </p>
                            ...
                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                                ...
                                LCShop, which are sent directly to users' browser. They automatically receive your IP
                            ...
                            <p>Note that LCShop has no access to or control over these cookies that are used by
                                third-party advertisers.</p>

                            <h2>Third Party Privacy Policies</h2>

                            <p>LCShop's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                            ...
                            <p>LCShop does not knowingly collect any Personal Identifiable Information from children
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to
                                our website with regards to the information that they shared and/or collect in LCShop.
                                This policy is not applicable to any information collected offline or via channels other
                                than this website.</p>

                            <h2>Consent</h2>

                            <p>By using our website, you hereby consent to our Privacy Policy and have read our <Link
                                    to="#">Disclaimer</Link>.</p>
                        </div>
                    </div>
                </div>                
            </Template>
